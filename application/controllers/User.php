...
class User extends CI_Controller
{
    ...
    {
        parent::__construct();
        is_logged_in(); //harus di daftarkan terlebih dahulu di helpers
    }
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($upload_image) {
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    if ($old_image != 'default.jpg') {  //untuk mengecek foto yang sudah di upload tadi
                        unlink(FCPATH . 'assets/img/profile/' . $old_image);  //unlink untuk mengahpus //FC = FrontController
                    }
